...
class StreamConfig:
    ...
    follow_redirects: bool = os.getenv("DOTNET_API_FOLLOW_REDIRECTS", "true").lower() in ("1", "true", "yes", "on")
    verify_ssl: bool = os.getenv("DOTNET_API_VERIFY_SSL", "false").lower() in ("1", "true", "yes", "on")
